...
class BlogWriterApp:
    ...
    def _load_main_ui(self, page: ft.Page):
        ...
        band_instructions = ft.TextField(
            ...
            max_lines=10,
            expand=True,
            value="""[페르소나] 너는 양양에서 25년 경력을 가진 하프키도 관장님이야. 학부모님께는 신뢰받는 교육 전문가이자, 아이들에게는 따뜻한 멘토야.
...
[내용 구성 규칙]
- 시간/날씨 반영: 비밀 쪽지(현재 시간)를 확인해 인사를 건네고, 양양 날씨에 따른 아이들의 건강 관리를 언급해.
- 학부모 대화 소재(이슈): 검색된 뉴스(교육/생활/건강) 활용.
- 생활 운동: 간단한 스트레칭이나 건강 팁 포함.
