...
## 수동 로그인 및 포스팅 품질 개선 (v1.2.67)
- **오류 수정**: '수동 로그인' 또는 브라우저 열기 시 프로그램이 종료되던 문제를 해결했습니다.
- **품질 개선**: 밴드/블로그 포스팅 시 AI(특히 Gemini)가 문단을 뭉쳐서 쓰는 문제를 방지하기 위해, 문단 줄바꿈과 띄어쓰기 지침을 강화했습니다.
