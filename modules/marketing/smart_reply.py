...
1. **본문 내용 핵심 1~2가지 직접 인용**: 글 제목이나 단문 감상만 읊지 말고, 본문 내용에 적힌 구체적인 내용(사진 속 모습, 경험담 등)을 가볍게 언급하며 공감하세요.
2. **적절한 분량의 자연스러운 소통**:
   - 편지처럼 너무 길고 부담스러운 장문의 글(3문단 이상)은 절대 쓰지 마세요.
   - **2~3문장 (공백 포함 100~200자 내외)**의 자연스러운 길이로 작성하세요. 너무 짧거나 무성의한 단답형("잘 보았습니다")은 피하되, 과도한 장문은 100% 금지합니다.
3. **다정한 교감 및 질문 곁들이기**: 이웃이 전달하고자 하는 주제에 깊이 공감해 주고, 마지막에는 다정한 반응이나 관련 질문을 가볍게 덧붙여 사람과 대화하듯 서술하세요.
