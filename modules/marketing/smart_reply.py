...
2. **풍성하고 정성스러운 분량 (2배 확대)**:
   - 최소 **3~4문단 이상 (5~7문장, 공백 포함 300자 ~ 500자 내외)**의 풍성한 분량으로 작성하세요.
   - 단 1문장이나 2문장의 짧거나 무성의한 댓글(예: "~과정이 정말 중요하네요!", "~잘 보았습니다!")은 100% 엄격히 금지합니다.
...
- {intent_instruction}
- {marketing_block}
- 분량: 단답형(예: "감사합니다", "~중요하네요")은 절대 피하고, 반드시 5~7문장 이상 (공백 포함 300자 ~ 500자 내외)으로 풍성하고 정성스럽게 작성하세요.
