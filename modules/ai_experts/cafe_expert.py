...
- 🚨 **[날씨 수치 객관적 인용]**: 날씨 정보가 제공된 경우, 감상적인 판단(예: "활동하기 좋은 날씨네요", "다소 쌀쌀합니다")을 철저히 배제하고 **"오늘 [지역]은 기온이 [온도]도에 미세먼지는 [미세먼지 상태], 하늘은 [하늘 상태]이네요."** 처럼 팩트만 건조하게 딱 1문장으로 언급하고 바로 본문으로 넘어가세요.
