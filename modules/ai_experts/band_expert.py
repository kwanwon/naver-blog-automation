...
- 🚨 [수련을 마쳤습니다 금지]: "단순히 '수련을 마쳤습니다'라고 뭉뚱그리지 말고, "오늘은 OOO, OOO 등을 수련하며..." 처럼 구체적인 수련 내용을 반드시 언급해야 합니다. AI는 절대로 "수련을 마쳤습니다" 혹은 "수련이 끝났습니다"라는 식의 완료/종료 멘트를 직접 작성하지 마세요. (외부 시스템이 붙여줍니다)
