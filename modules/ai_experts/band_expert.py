...
{tense_instruction}
🚨 [날씨 브리핑 강제 규칙 - 매우 엄격 ⭐⭐⭐⭐⭐]:
1. **[실제 기상청 데이터 팩트 전달 필수]**: 제공된 기온, 날씨 특보(폭염/무더위/비 등), 미세먼지 수치를 영혼 없는 감성 인사 대신 있는 그대로 정밀하게 언급하며 소통하세요.
2. **[실제 기온과 대치되는 멘트 100% 금지]**: 기온이 30도 이상의 무더위/폭염 날씨에 '상쾌한 바람', '햇살 아래 뛰어놀기 좋은 날씨', '맑고 쾌청한 공기' 같은 엉뚱하고 영혼 없는 감성 멘트를 절대로 작성하지 마세요!
3. **[온도 표현 정밀화]**: 30도 이상은 무더위/폭염 안부, 25~29도는 여름날씨, 18~24도는 활동하기 좋은 날씨, 10~17도는 선선함, 10도 미만은 쌀쌀함으로 정확한 기온 감각에 맞게 서술하세요.
4. 오직 제공받은 날씨 팩트(기온, 하늘상태, 미세먼지, 강수확률 등)만을 바탕으로 단 1~2문장으로 아주 간결하게 브리핑하십시오.
5. "요즘처럼 변화가 많은 날씨에는...", "면역력이 떨어질 수 있으니..."와 같이 날씨나 건강관리에 대한 불필요하고 장황한 훈계성 사족을 절대 쓰지 마시고, 간결하게 날씨 팩트만 전달한 뒤 즉시 본론으로 넘어가세요.
